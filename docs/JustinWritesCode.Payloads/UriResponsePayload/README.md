...
```csharp
public class UriResponsePayload : JustinWritesCode.Payloads.ResponsePayload<uri>
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [Payload\<T\>](../Payload-1/README.md) &#x2192; [ResponsePayload\<T\>](../ResponsePayload-1/README.md) &#x2192; UriResponsePayload

### Implements

* JustinWritesCode\.Payloads\.Abstractions\.[IPayload](../Abstractions/IPayload/README.md)
* JustinWritesCode\.Payloads\.Abstractions\.[IPayload](../Abstractions/IPayload-1/README.md)\<[uri](https://docs.microsoft.com/en-us/dotnet/api/system.uri)\>
* JustinWritesCode\.Payloads\.Abstractions\.[IResponsePayload](../Abstractions/IResponsePayload/README.md)
* JustinWritesCode\.Payloads\.Abstractions\.[IResponsePayload](../Abstractions/IResponsePayload-1/README.md)\<[uri](https://docs.microsoft.com/en-us/dotnet/api/system.uri)\>
...
| Constructor | Summary |
| ----------- | ------- |
| [UriResponsePayload(uri, String)](-ctor/README.md) | |
...
| [StringValue](StringValue/README.md) |  \(Overrides [Payload\<uri\>.StringValue](../Payload-1/StringValue/README.md)\) |
