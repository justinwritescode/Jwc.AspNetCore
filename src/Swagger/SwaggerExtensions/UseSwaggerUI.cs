...
public static partial class UseSwaggerUIExtensions
{
    ...
    public static WebApplication UseCustomizedSwaggerUI<TAssemblyResource>(this WebApplication app, Type tThisAssemblyProject, string? indexDocumentAssemblyResourceName = "SwaggerUI.index.html", string? swaggerTheme = null)
    {
        ...
        _ = app.MapGet("/swagger-ui/SwaggerUI.custom.css", () => CustomCss(swaggerTheme ?? new ThisAssemblyProject(tThisAssemblyProject).SwaggerTheme)).WithOpenApi(op =>
           {
               op.Responses["200"] = new OpenApiResponse { Description = "Custom CSS", Content = { [TextMediaTypeNames.Css] = new OpenApiMediaType { Schema = new OpenApiSchema { Type = TextMediaTypeNames.Css, Description = "custom css" },
        ...
        _ = app.MapGet($"/swagger/{thisAssemblyProject.Version}/swagger.json", ctx => { ctx.Response.Redirect($"/swagger/v1/swagger.json"); return Task.CompletedTask; });
