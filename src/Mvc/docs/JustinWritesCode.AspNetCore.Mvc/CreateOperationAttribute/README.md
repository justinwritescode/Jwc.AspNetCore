# CreateOperationAttribute Class
...
```csharp
public class CreateOperationAttribute : JustinWritesCode.AspNetCore.Mvc.JwcOperationAttribute
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) &#x2192; SwaggerOperationAttribute &#x2192; [JwcOperationAttribute](../JwcOperationAttribute/README.md) &#x2192; CreateOperationAttribute
...
| Constructor | Summary |
| ----------- | ------- |
| [CreateOperationAttribute(String, String, String, String\[\])](-ctor/README.md) | |
