...
Represents a response payload with an  value

```csharp
public class IntResponsePayload : JustinWritesCode.Payloads.ResponsePayload<int>
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [Payload\<T\>](../Payload-1/README.md) &#x2192; [ResponsePayload\<T\>](../ResponsePayload-1/README.md) &#x2192; IntResponsePayload
...
* JustinWritesCode\.Payloads\.Abstractions\.[IResponsePayload](../Abstractions/IResponsePayload-1/README.md)\<[Int32](https://docs.microsoft.com/en-us/dotnet/api/system.int32)\>
...
| Constructor | Summary |
| ----------- | ------- |
| [IntResponsePayload(Int32, String)](-ctor/README.md) | |
