# CreatedResponsePayload\<T\> Class
...
```csharp
public class CreatedResponsePayload<T> : JustinWritesCode.Payloads.ResponsePayload<T>
```
...
[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [Payload\<T\>](../Payload-1/README.md) &#x2192; [ResponsePayload\<T\>](../ResponsePayload-1/README.md) &#x2192; CreatedResponsePayload\<T\>
...
| Constructor | Summary |
| ----------- | ------- |
| [CreatedResponsePayload(T, uri)](-ctor/README.md) | |
