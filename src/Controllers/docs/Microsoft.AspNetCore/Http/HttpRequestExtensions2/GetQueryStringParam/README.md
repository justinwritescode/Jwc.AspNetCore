# HttpRequestExtensions2\.GetQueryStringParam\<T\>\(HttpRequest, String, T\) Method
...
```csharp
public static T GetQueryStringParam<T>(this Microsoft.AspNetCore.Http.HttpRequest req, string name, T defaultValue = default)
```
